    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('peminjaman.index')->with('success', 'Data Peminjaman berhasil ditambahkan dan Jumlah Barang Berhasil Diperbarui.');
}
    ...
    public function update(Request $request, $id)
{
    ...
    if ($request->input('status') === 'Dikembalikan') {
        ...
        return redirect()->route('peminjaman.index')->with('success', 'Data peminjaman berhasil diperbarui, jumlah barang berhasil dikembalikan, dan data disimpan ke riwayat.');
    }
...
{
    // Temukan data peminjaman yang akan dihapus
    $dataPeminjaman = DataPeminjaman::findOrFail($id);

    // Temukan data barang yang dipinjam
    $barang = DataBarang::findOrFail($dataPeminjaman->kode_barang);
