                ...
                @foreach ($dataPeminjamen as $peminjaman)
                    <tr>
                        ...
                        <td data-label="Kode Barang">
                            {{ $peminjaman->dataBarang->kode_barang ?? 'Data Barang tidak ditemukan' }}</td>
                        <td data-label="Nama Barang">
                            {{ $peminjaman->dataBarang->nama_barang ?? 'Data Barang tidak ditemukan' }}</td>
                        <td data-label="Kode Ruangan">
                            {{ $peminjaman->dataRuangan->kode_ruangan ?? 'Data Ruangan tidak ditemukan' }}</td>
